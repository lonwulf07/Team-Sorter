...
df= pd.read_excel('Team_Sheet.xlsx')

LW = df['LW'].head(10).tolist()
RW = df['RW'].head(10).tolist()
ST = df['ST'].head(10).tolist()
AM_DM = df['AM/DM'].head(10).tolist()
CM = df['CM'].head(20).tolist()
LB = df['LB'].head(10).tolist()
RB = df['RB'].head(10).tolist()
CB = df['CB'].head(20).tolist()
GK = df['GK'].head(10).tolist()
